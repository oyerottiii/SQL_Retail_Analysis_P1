...
-- Q) Unique customer count?
select count(distinct customer_id) as total_sales from retail_sales

-- Q) What all categories are there?
...
with cte as (
select avg(total_sale) as avg_sale, extract(month from sale_date) as month, extract(year  from sale_date) as year,
